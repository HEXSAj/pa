// src/app/dashboard/referral-doctors/AddReferralDoctorModal.tsx
'use client';

import { useState } from 'react';
import { referralDoctorService, ReferralDoctorExistsError } from '@/services/referralDoctorService';
import { ReferralDoctorFormData } from '@/types/referralDoctor';
import { 
  Dialog, 
  DialogContent, 
  DialogHeader, 
...
interface AddReferralDoctorModalProps {
  onClose: () => void;
  onSuccess: () => void;
}

export default function AddReferralDoctorModal({ onClose, onSuccess }: AddReferralDoctorModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      await referralDoctorService.create({
        ...formData,
        isActive
      });
      ...
      if (error instanceof ReferralDoctorExistsError) {
        ...
        toast.error('Failed to add referral doctor');
      }
    } finally {
      setLoading(false);
    }
