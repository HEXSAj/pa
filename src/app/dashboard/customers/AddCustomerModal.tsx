...
type FormData = {
  ...
  loyaltyPoints: string; // Added loyalty points field
};
...
export default function AddCustomerModal({ onClose, onSuccess }: AddCustomerModalProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      loyaltyPoints: '0', // Default to 0 points
    },
  });
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      // Convert discount percentage and loyalty points to numbers
      ...
      await customerService.create({
        ...
        loyaltyPoints: loyaltyPoints // Added loyalty points
      });
